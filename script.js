const WORDS = [
  ...
  {word:"afford",meaning:"负担得起",example:"I cannot afford a new phone right now.",translation:"我现在负担不起一部新手机。"},
  ...
  {word:"creative",meaning:"有创意的",example:"She found a creative way to decorate the box.",translation:"她想出了一个有创意的方法装饰这个盒子。"},
  ...
  {word:"capable",meaning:"有能力的",example:"She is capable of solving the problem herself.",translation:"她有能力自己解决问题。"},
  ...
  {word:"resourceful",meaning:"足智多谋的；善于解决问题的",example:"She is resourceful when facing unexpected problems.",translation:"面对意外问题时，她总是很会想办法。"},
  {word:"recognition",meaning:"认可；认出",example:"Her hard work finally received recognition.",translation:"她的努力终于得到了认可。"},
  {word:"recover",meaning:"恢复；康复",example:"It took him a few days to recover from the long journey.",translation:"他花了几天时间从漫长的旅程中恢复过来。"},
  {word:"participate",meaning:"参加；参与",example:"Everyone is welcome to participate in the activity.",translation:"欢迎每个人参加这项活动。"},
  {word:"observe",meaning:"观察；遵守",example:"We spent some time observing the birds.",translation:"我们花了一些时间观察鸟儿。"},
  {word:"motivate",meaning:"激励；促使",example:"Small goals can motivate you to keep going.",translation:"小目标可以激励你继续前进。"},
  {word:"generation",meaning:"一代人；世代",example:"Each generation has its own experiences.",translation:"每一代人都有自己的经历。"},
  {word:"freedom",meaning:"自由",example:"Everyone deserves the freedom to make their own choices.",translation:"每个人都应该拥有做出自己选择的自由。"},
  {word:"conclusion",meaning:"结论；结束",example:"We reached the same conclusion.",translation:"我们得出了相同的结论。"},
  {word:"circumstance",meaning:"情况；环境",example:"Under these circumstances, we should wait.",translation:"在这种情况下，我们应该等待。"},
  {word:"capability",meaning:"能力；才能",example:"The device has the capability to store large files.",translation:"这个设备具有储存大量文件的能力。"},
  {word:"attitude",meaning:"态度",example:"A positive attitude can make a big difference.",translation:"积极的态度可以带来很大的改变。"},
  {word:"analyze",meaning:"分析",example:"We need to analyze the results carefully.",translation:"我们需要仔细分析结果。"},
  {word:"tolerate",meaning:"容忍；忍受",example:"I cannot tolerate such loud noise for long.",translation:"我无法长时间忍受这么大的噪音。"},
  {word:"strengthen",meaning:"加强；增强",example:"Regular practice can strengthen your skills.",translation:"定期练习可以增强你的技能。"},
  {word:"select",meaning:"选择；挑选",example:"Please select the answer that you think is correct.",translation:"请选择你认为正确的答案。"},
  {word:"reveal",meaning:"揭示；透露",example:"The letter revealed an important secret.",translation:"这封信揭示了一个重要的秘密。"},
  {word:"restore",meaning:"恢复；修复",example:"The workers helped restore the old building.",translation:"工人们帮助修复了那座老建筑。"},
  {word:"respond",meaning:"回应；回答",example:"Please respond to the message when you have time.",translation:"你有时间时请回复这条信息。"},
  {word:"preserve",meaning:"保存；保护",example:"We should preserve traditional culture.",translation:"我们应该保护传统文化。"},
  {word:"establish",meaning:"建立；确立",example:"The company hopes to establish a strong reputation.",translation:"这家公司希望建立良好的声誉。"},
  {word:"emerge",meaning:"出现；浮现",example:"New ideas began to emerge during the discussion.",translation:"讨论期间开始出现新的想法。"},
  {word:"decrease",meaning:"减少；下降",example:"The number of visitors began to decrease.",translation:"访客人数开始减少。"},
  {word:"confirm",meaning:"确认；证实",example:"Please confirm your booking before Friday.",translation:"请在星期五之前确认你的预订。"},
  {word:"complex",meaning:"复杂的",example:"The problem is more complex than it first appeared.",translation:"这个问题比一开始看起来更加复杂。"},
  {word:"communicate",meaning:"沟通；交流",example:"Good communication is important in every workplace.",translation:"良好的沟通在每个工作场所都很重要。"},
  {word:"cautious",meaning:"谨慎的；小心的",example:"You should be cautious when crossing the busy road.",translation:"过繁忙的马路时应该小心。"},
  {word:"achieve",meaning:"达到；实现",example:"She worked hard to achieve her goal.",translation:"她努力实现自己的目标。"},
  {word:"admit",meaning:"承认",example:"He finally admitted that he was wrong.",translation:"他最终承认自己错了。"},
  {word:"advise",meaning:"建议",example:"I would advise you to check the information again.",translation:"我建议你再检查一次资料。"},
  {word:"belong",meaning:"属于",example:"This bag belongs to my sister.",translation:"这个包是我妹妹的。"},
  {word:"bother",meaning:"麻烦；使烦恼",example:"Does the noise bother you?",translation:"这个噪音会让你觉得烦吗？"},
  {word:"compare",meaning:"比较",example:"It is useful to compare the two options.",translation:"比较这两个选择是有帮助的。"},
  {word:"complain",meaning:"抱怨",example:"He always complains about the weather.",translation:"他总是抱怨天气。"},
  {word:"delay",meaning:"延迟；耽搁",example:"The flight was delayed because of bad weather.",translation:"航班因为天气不好而延误了。"},
  {word:"demand",meaning:"要求；需求",example:"The job demands a lot of patience.",translation:"这份工作需要很大的耐心。"},
  {word:"forgive",meaning:"原谅",example:"I hope you can forgive my mistake.",translation:"我希望你能原谅我的错误。"},
  {word:"involve",meaning:"涉及；包含",example:"The project involves working with many people.",translation:"这个项目涉及与很多人一起工作。"},
  {word:"manage",meaning:"管理；设法做到",example:"She managed to finish everything before dinner.",translation:"她设法在晚餐前完成了所有事情。"},
  {word:"prefer",meaning:"更喜欢；宁愿",example:"I prefer tea to coffee.",translation:"比起咖啡，我更喜欢茶。"},
  {word:"realize",meaning:"意识到；实现",example:"I didn't realize how late it was.",translation:"我没有意识到已经这么晚了。"},
  {word:"solve",meaning:"解决",example:"We need to solve this problem together.",translation:"我们需要一起解决这个问题。"},
  {word:"suggest",meaning:"建议；提议",example:"She suggested taking a short break.",translation:"她建议休息一下。"},
  {word:"trust",meaning:"信任",example:"It takes time to build trust.",translation:"建立信任需要时间。"},
  {word:"vary",meaning:"变化；不同",example:"Prices may vary depending on the season.",translation:"价格可能会根据季节而有所不同。"},
  {word:"protect",meaning:"保护",example:"We should protect the environment.",translation:"我们应该保护环境。"},
  {word:"share",meaning:"分享；共用",example:"She likes to share her ideas with others.",translation:"她喜欢和别人分享自己的想法。"},
  {word:"wonder",meaning:"想知道；好奇",example:"I wonder what will happen next.",translation:"我想知道接下来会发生什么。"},
  {word:"deliver",meaning:"递送；交付",example:"The shop can deliver the order to your home.",translation:"这家店可以把订单送到你家。"},
  {word:"admit",meaning:"承认",example:"She admitted that she had forgotten the appointment.",translation:"她承认自己忘记了预约。"}, 
］；
